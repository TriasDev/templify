...
var data = new Dictionary<string, object>
{
    ...
    // Item 1
    ["Item1Name"] = "ViasPro Enterprise License",
    ["Item1Quantity"] = 5,
    ["Item1Price"] = 499.00m,
    ["Item1Total"] = 2495.00m,
...
var data = new Dictionary<string, object>
{
    ...
    ["LineItems"] = new List<LineItem>
    {
        ...
        {
            Position = 1,
            Product = "ViasPro Enterprise License",
            Quantity = 5,
            UnitPrice = 499.00m,
            Total = 2495.00m
        },
...
var data = new Dictionary<string, object>
{
    ["ProjectName"] = "ViasPro Development",
    ["Tasks"] = new List<Task>
    {
...
Dictionary<string, object> data = new Dictionary<string, object>
{
    ...
    {
        new Product { Name = "ViasPro Enterprise", Price = 999.00m, InStock = true },
        new Product { Name = "ViasPro Professional", Price = 499.00m, InStock = true },
        new Product { Name = "ViasPro Starter", Price = 199.00m, InStock = true }
    }
};
```
...
• ViasPro Enterprise - 999.00 EUR
• ViasPro Professional - 499.00 EUR
• ViasPro Starter - 199.00 EUR
```
...
var data = new Dictionary<string, object>
{
    ...
    {
        new InvoiceItem { Description = "ViasPro License", Quantity = 5, UnitPrice = 499.00m, Total = 2495.00m },
