...
internal class Program
{
    ...
    static Dictionary<string, object> CreateComprehensiveTestData()
    {
        return new Dictionary<string, object>
        {
            ...
            {
                new ProductInfo { Name = "ViasPro Enterprise", Price = 999.00m, Available = true },
                new ProductInfo { Name = "ViasPro Professional", Price = 499.00m, Available = true },
                new ProductInfo { Name = "ViasPro Starter", Price = 199.00m, Available = true }
            },
