...
public sealed class LoopTests
{
    ...
    public void ProcessTemplate_SimpleLoop_RepeatsContentForEachItem()
    {
        ...
        Dictionary<string, object> data = new Dictionary<string, object>
        {
            ...
            {
                new LineItem { Position = 1, Product = "ViasPro License", Quantity = 5, UnitPrice = 499.00m, Total = 2495.00m },
        ...
        Assert.Contains("1. ViasPro License", paragraphs[1]);
    ...
    public void ProcessTemplate_TableRowLoop_RepeatsRows()
    {
        ...
        Dictionary<string, object> data = new Dictionary<string, object>
        {
            ["LineItems"] = new List<LineItem>
            {
                new LineItem { Position = 1, Product = "ViasPro License", UnitPrice = 499.00m },
        ...
        Assert.Equal("ViasPro License", tableCells[1][1]);
